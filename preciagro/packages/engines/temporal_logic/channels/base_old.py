...
class TemplateManager:
    ...
    def get_template(self, template_id: str, channel: Optional[str] = None) -> Optional[Dict[str, Any]]:
...
class ChannelManager:
    ...
    async def send_message(self, channel_name: str, message_request: MessageRequest) -> MessageResult:

...
class CaptureService:
    ...
    async def get_events_for_recommendation(
        ...
        """
        events = [e for e in self._event_store.values() if e.recommendation_id == recommendation_id]
    ...
    async def _store_event(self, event: FeedbackEvent) -> None:
        ...
        existing_count = await self.count_events(recommendation_id=event.recommendation_id)

...
class QuietHoursPolicy:
    ...
    def apply_policy(
        self, scheduled_time: datetime, message_type: str = "default", priority: int = 5
    ) -> Tuple[datetime, str]:
        """
...
class ChannelSpecificQuietHours:
    ...
    def add_channel_policy(
        ...
        # FIX: Removed unused ChannelConfig shim — lint flagged unused assignment; direct instantiation keeps behaviour identical.

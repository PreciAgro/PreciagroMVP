...
class TestEvidenceCollector:
    ...
    def test_collect_with_preloaded_evidence(self):
        ...
        request = ExplanationRequest(
            ...
            evidence=[{"type": "image", "source_engine": "image_analysis", "source_id": "img_1"}],
        )
    ...
    def test_add_image_evidence(self):
        ...
        evidence = collector.add_image_evidence(
            image_id="img_123", summary="Crop image showing leaf spots"
        )
    ...
    def test_add_sensor_evidence(self):
        ...
        sensor_data = {"type": "temperature", "value": 25.5, "unit": "°C"}

        evidence = collector.add_sensor_evidence(sensor_data=sensor_data, sensor_id="temp_001")
...
class TestConfidenceEstimator:
    ...
    def test_estimate_single_model(self):
        ...
        metrics = estimator.estimate([{"confidence": 0.85, "prediction": "rust"}])
    ...
    def test_estimate_ensemble(self):
        ...
        metrics = estimator.estimate(
            [{"confidence": 0.9}, {"confidence": 0.85}, {"confidence": 0.88}]
        )
    ...
    def test_estimate_with_disagreement(self):
        ...
        metrics = estimator.estimate(
            [{"confidence": 0.95}, {"confidence": 0.3}, {"confidence": 0.6}]
        )
...
class TestSafetyGate:
    ...
    def test_detect_banned_chemical(self):
        ...
        result = gate.validate(
            recommendation={"action": "Apply DDT pesticide"}, context={"region": "ZW-HA"}
        )
    ...
    def test_missing_ppe_warning(self):
        ...
        result = gate.validate(recommendation={"action": "Spray pesticide on crops"}, context={})
...
class TestReasoningTraceBuilder:
    ...
    def test_build_full_trace(self):
        ...
        evidence = EvidenceItem(
            evidence_type=EvidenceType.IMAGE, source_engine="image_analysis", source_id="img_1"
        )

        model = ModelInfo(
            model_id="clf_v1", model_name="Classifier", model_version="1.0", model_type="cv"
        )

...
Four output shapes (per spec section 05):
  - critical:        urgency == "critical" → ⚠️ URGENT, Action first
  - standard:        confidence >= 0.60 and urgency != "critical"
  - low_confidence:  confidence < 0.60
  - error_fallback:  missing required fields or empty dict
"""

...
class TestExplainEndpoint:
    ...
    def test_explain_tabular(self, client):
        ...
        request = {
            "model_type": "tabular",
            "model_id": "xgb_v1",
            "model_outputs": {"diagnosis": "rust", "confidence": 0.85},
    ...
    def test_explain_cv(self, client):
        ...
        request = {
            ...
            "model_outputs": {"prediction": "leaf_blight", "confidence": 0.92},
...
class TestExplainFastEndpoint:
    ...
    def test_explain_fast(self, client):
        ...
        request = {
            "model_type": "tabular",
            "model_id": "test",
            "model_outputs": {"diagnosis": "powdery_mildew", "confidence": 0.75},
        }

...
class LocalIntelligenceAdapter:
    ...
    def __init__(self, local_rules_dir: Optional[str] = None):
        ...
        """
        self.local_rules_dir = Path(local_rules_dir) if local_rules_dir else Path(__file__).parent.parent / "local_rules"
    ...
    def get_rules(
        ...
        matching_rules = [
            ...
            and (crop_variety is None or rule.crop_variety == crop_variety or rule.crop_variety is None)
        ]

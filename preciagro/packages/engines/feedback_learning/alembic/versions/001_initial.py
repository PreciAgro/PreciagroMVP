...
def upgrade() -> None:
    ...
    op.create_index(
        'ix_feedback_events_rec_type',
        'feedback_events',
        ['recommendation_id', 'feedback_type']
    )
    op.create_index(
        'ix_feedback_events_region_time',
        'feedback_events',
        ['region_code', 'created_at']
    )
    op.create_index(
        'ix_feedback_events_user_time',
        'feedback_events',
        ['user_id', 'created_at']
    )
    ...
    op.create_index(
        'ix_weighted_feedback_region_flagged',
        'weighted_feedback',
        ['region_code', 'is_flagged']
    )
    ...
    op.create_index(
        'ix_learning_signals_target_routed',
        'learning_signals',
        ['target_engine', 'is_routed']
    )
    op.create_index(
        'ix_learning_signals_rec_type',
        'learning_signals',
        ['recommendation_id', 'signal_type']
    )
    op.create_index(
        'ix_learning_signals_model_strength',
        'learning_signals',
        ['model_id', 'signal_strength']
    )

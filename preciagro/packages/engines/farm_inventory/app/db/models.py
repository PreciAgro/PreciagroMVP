...
class InventoryItem(Base):
    ...
    unit: Mapped[str] = mapped_column(
        sa.Enum(InventoryUnit, name="inventory_unit"), nullable=False
    )
...
class InventoryAlert(Base):
    ...
    severity: Mapped[str] = mapped_column(
        sa.String(20), nullable=False  # "warning", "critical"
    )
...
class SyncState(Base):
    ...
    farmer_id: Mapped[str] = mapped_column(sa.String(100), nullable=False, index=True)
    entity_type: Mapped[str] = mapped_column(sa.String(50), nullable=False)  # "item", "usage", "alert"
    entity_id: Mapped[str] = mapped_column(sa.String(100), nullable=False)
    operation: Mapped[str] = mapped_column(sa.String(20), nullable=False)  # "create", "update", "delete"

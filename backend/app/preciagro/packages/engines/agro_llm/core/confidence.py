...
class ConfidenceCalibrator:
    ...
    def extract_factors(
        ...
        factors.known_pattern_match = self._calculate_pattern_match(llm_output, request_context)
    ...
    def _calculate_pattern_match(
        self, llm_output: Dict[str, Any], request_context: Optional[Dict[str, Any]]
    ) -> float:

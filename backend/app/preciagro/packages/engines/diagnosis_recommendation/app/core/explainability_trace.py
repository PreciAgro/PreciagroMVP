...
class ExplainabilityTraceEngine:
    ...
    def _build_rationale(
        self, diagnosis: Diagnosis, recommendation_plan: RecommendationPlan
    ) -> str:
        ...
        if recommendation_plan.recommendations:
            ...
            if high_priority:
                rationale_parts.append(f"{len(high_priority)} high-priority actions recommended")
        else:
    ...
    def _extract_applied_rules(self, reasoning_steps: List[Dict[str, Any]]) -> List[str]:

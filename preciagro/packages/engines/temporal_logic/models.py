...
class ScheduleItem(Base):
    ...
    # Relationships
    jobs: Mapped[list["NotificationJob"]] = relationship(back_populates="schedule", cascade="all, delete-orphan")
...
class NotificationAudit(Base):
    ...
    event: Mapped[str] = mapped_column(Text)  # 'enqueue'|'send_attempt'|'send_success'|'send_fail'|'receipt'

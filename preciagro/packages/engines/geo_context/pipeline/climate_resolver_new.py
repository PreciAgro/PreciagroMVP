...
class ClimateResolver:
    ...
    async def _get_forecast_data(
        self, lat: float, lon: float, reference_date: datetime, days: int
    ) -> Dict:
    ...
    def _calculate_et0_hargreaves(
        ...
        try:
            ...
            # Solar declination
            solar_dec = 0.4093 * math.sin(2 * math.pi * day_of_year / 365 - 1.405)
            ...
            # Hargreaves equation
            et0 = 0.0023 * (temp_avg + 17.8) * math.sqrt(temp_max - temp_min) * ra

...
class FlaggedFeedbackOutput(BaseModel):
    ...
    # Related flags
    related_flag_ids: List[str] = Field(default_factory=list, description="Related flag IDs")
...
class AuditExportOutput(BaseModel):
    ...
    # Scope
    export_type: Literal["feedback", "signal", "batch"] = Field(..., description="Type of export")
    ...
    # Lineage
    source_feedback_ids: List[str] = Field(default_factory=list, description="Source feedback IDs")

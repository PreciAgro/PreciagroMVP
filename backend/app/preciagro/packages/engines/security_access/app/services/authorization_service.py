...
class AuthorizationService:
            ...
            if self._evaluate_policy(policy_def, subject_attrs, resource_attrs, action, context):
                ...
                if effect == "deny":
                    ...
                    if self._evaluate_conditions(
                        conditions, subject_attrs, resource_attrs, context
                    ):
                        return True
        ...
        for key, value in pattern.items():
            ...
            if isinstance(value, list):
                ...
                if "$in" in value:
                    ...
                    # Recursive match
                    if not isinstance(attr_value, dict) or not self._match_attributes(
                        value, attr_value
                    ):
                        return False
            else:
    ...
    async def assign_role(
        self, actor_id: str, role_id: str, assigned_by: Optional[str] = None
    ) -> bool:

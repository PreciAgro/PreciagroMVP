...
class EvidenceGraphBuilder:
    ...
    def build_graph(
        self, observations: List[Observation], context: Dict[str, Any]
    ) -> EvidenceGraph:
        """
    ...
    def _build_contextual_evidence(
        ...
        if region or crop_type or season:
            ...
            relevant_obs = [
                obs for obs in observations if self._is_contextually_relevant(obs, context)
            ]
    ...
    def _is_contextually_relevant(self, observation: Observation, context: Dict[str, Any]) -> bool:

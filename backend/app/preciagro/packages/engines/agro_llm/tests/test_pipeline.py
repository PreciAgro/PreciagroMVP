...
def sample_request():
    ...
    return {
        ...
        "field_id": "field_456",
        "geo": {"lat": 7.2906, "lon": 80.6337, "region_code": "LK-01"},
        "timestamp": datetime.utcnow().isoformat() + "Z",
        "language": "en",
        "text": "My maize plants are showing yellow leaves. What should I do?",
        "images": [],
        "image_features": [],
        "soil": {"pH": 6.5, "moisture": 45.0},
        "crop": {"type": "maize", "variety": "local"},
        "weather": {"temp": 28.0, "humidity": 75.0},
        "session_context": [],
        "consent": {"use_for_training": False},
    }
...
async def test_pipeline_with_images(sample_request):
    ...
    sample_request["image_features"] = [
        {"id": "img_1", "embedding": [0.1] * 128, "labels": ["leaf", "yellow"]}
    ]

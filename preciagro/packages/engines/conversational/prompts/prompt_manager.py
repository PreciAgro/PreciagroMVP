...
class PromptManager:
    ...
    def build_prompt(self, session: SessionData, user_query: str, context: Dict[str, Any], template_name: str = 'diagnosis') -> Dict[str, Any]:
        """
        ...
        formatted_prompt = template.format(context_str=context_str, user_query=user_query, **context)
